...
import SidebarItem from "@/components/TableauDeBordClient/Sidebar/SidebarItem";
import ClickOutside from "@/components/ClickOutside";
import useLocalStorage from "@/hooks/useLocalStorage";
import DeconnexionButton from "@/components/DeconnexionClient";
    ...
    menuItems: [
      {
        ...
        children: [
          {
            label: "Gérer",
            route: "/tableaudebordclient/projetclient/gerer",
          },
        ],
      },
    ],
    ...
    menuItems: [
      {
        ...
        route: "#",
        children: [
          { label: "Voir", route: "/tableaudebordclient/profil/voir" },
          {
            label: "Modifier",
            route: "/tableaudebordclient/profil/modifier",
          },
          {
            label: "Changer le mot de passe",
            route: "/tableaudebordclient/profil/changermotdepasse",
          },
        ],
      },
    ],
