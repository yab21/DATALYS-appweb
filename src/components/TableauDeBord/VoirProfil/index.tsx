...
const VoirProfil = () => {
  return (
    <>
      <Breadcrumb pageName="Voir mon profil" />
          ...
          <div className="container mx-auto py-8">
            <div className="grid grid-cols-4 gap-6 px-4 sm:grid-cols-12">
              <div className="col-span-4 sm:col-span-3">
                <div className="rounded-lg border-stroke bg-white p-6 shadow dark:border-stroke-dark dark:bg-gray-dark">
                  ...
                  <div className="flex flex-col">
                    <span className="mt-7 border-t-1 border-t-gray-700 text-sm font-bold uppercase tracking-wider text-gray-700 dark:border-t-white dark:text-white md:text-base">
                      Competences
                    </span>
                    <ul>
              ...
              <div className="col-span-4 sm:col-span-9">
                <div className="rounded-lg border-stroke bg-white p-6 shadow dark:border-stroke-dark dark:bg-gray-dark">
                  <h2 className="mb-4 text-xl font-bold">Apropos de moi</h2>
